.data
str_const_2_59: .asciiz "Resultados de operaciones aritmeticas:\n"
str_const_3_33: .asciiz "Suma (4 + 5): "
str_const_5_21: .asciiz "\n"
str_const_7_35: .asciiz "Resta (10 - 3): "
str_const_9_21: .asciiz "\n"
str_const_11_43: .asciiz "Multiplicacion (2 * 6): "
str_const_13_21: .asciiz "\n"
str_const_15_37: .asciiz "Division (8 / 2): "
str_const_17_21: .asciiz "\n"
str_const_19_35: .asciiz "Modulo (7 % 3): "
str_const_21_21: .asciiz "\n"
str_const_23_57: .asciiz "\nResultados de operaciones unarias:\n"
str_const_24_37: .asciiz "Decremento (--5): "
str_const_26_21: .asciiz "\n"
str_const_28_38: .asciiz "Incremento (++10): "
str_const_30_21: .asciiz "\n"
str_const_32_59: .asciiz "\nResultados de operaciones booleanas:\n"
str_const_33_33: .asciiz "AND (1 && 0): "
str_const_35_21: .asciiz "\n"
str_const_37_32: .asciiz "OR (1 || 0): "
str_const_39_21: .asciiz "\n"
str_const_41_29: .asciiz "NOT (!1): "
str_const_43_21: .asciiz "\n"
str_const_45_62: .asciiz "\nResultados de operaciones relacionales:\n"
str_const_46_38: .asciiz "Mayor que (5 > 3): "
str_const_48_21: .asciiz "\n"
str_const_50_40: .asciiz "Mayor que (-7 > 78): "
str_const_52_21: .asciiz "\n"
str_const_54_38: .asciiz "Mayor que (0 > 0): "
str_const_56_21: .asciiz "\n"
str_const_58_45: .asciiz "Mayor igual que (5 >= 3): "
str_const_60_21: .asciiz "\n"
str_const_62_47: .asciiz "Mayor igual que (-7 >= 78): "
str_const_64_21: .asciiz "\n"
str_const_66_45: .asciiz "Mayor igual que (0 >= 0): "
str_const_68_21: .asciiz "\n"
str_const_70_38: .asciiz "Menor que (2 < 4): "
str_const_72_21: .asciiz "\n"
str_const_74_39: .asciiz "Menor que (24 < 4): "
str_const_76_21: .asciiz "\n"
str_const_78_38: .asciiz "Menor que (4 < 4): "
str_const_80_21: .asciiz "\n"
str_const_83_45: .asciiz "Menor igual que (2 <= 4): "
str_const_85_21: .asciiz "\n"
str_const_87_46: .asciiz "Menor igual que (24 <= 4): "
str_const_89_21: .asciiz "\n"
str_const_91_45: .asciiz "Menor igual que (4 <= 4): "
str_const_93_21: .asciiz "\n"
str_const_96_37: .asciiz "Igual a (6 == 6): "
str_const_98_21: .asciiz "\n"
str_const_100_38: .asciiz "Igual a (-6 == 6): "
str_const_102_21: .asciiz "\n"
str_const_104_39: .asciiz "Igual a (6.0 == 6): "
double_const_105_23: .double 6.0
str_const_106_21: .asciiz "\n"
str_const_108_42: .asciiz "Diferente de (7 != 5): "
str_const_110_21: .asciiz "\n"
str_const_112_42: .asciiz "Diferente de (5 != 5): "
str_const_114_21: .asciiz "\n"
str_const_116_44: .asciiz "Diferente de (5 != 5.0): "
double_const_117_23: .double 5.0
double_const_117_28: .double 5.0
str_const_118_21: .asciiz "\n"
...
main:
	...
	li $a0, 48  #  len() bytes + padding + su vtable
	...
	la $a0, str_const_2_59 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_3_33 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_5_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_7_35 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_9_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_11_43 # Guardamos el valor en la CIR en un temporal
	...
	li $t0, 6 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_15_37 # Guardamos el valor en la CIR en un temporal
	...
	li $t0, 8 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_17_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_19_35 # Guardamos el valor en la CIR en un temporal
	...
	li $t0, 7 # Guardamos el valor en la CIR en un temporal
	...
	div $t0, $t1 #dividimos los dos int

	mfhi $t0 #guardamos el resultado en $t0 del resto
	...
	la $a0, str_const_21_21 # Guardamos el valor en la CIR en un temporal
	...
	li $a0, 44  #  len() bytes + padding + su vtable
	...
	la $a0, str_const_23_57 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_24_37 # Guardamos el valor en la CIR en un temporal
	...
	addi $t0, $t0, -1 #decrementar el valor del int
	...
	la $a0, str_const_26_21 # Guardamos el valor en la CIR en un temporal
	...
	li $a0, 28  #  len() bytes + padding + su vtable
	...
	la $a0, str_const_28_38 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_30_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_32_59 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_33_33 # Guardamos el valor en la CIR en un temporal
	...
	#Comienza codigo para llamada de metodo out_bool
	...
	la $t0, VTABLE_Bool # Cargar la dirección de la vtable de Int en un temporal

	sw $t0, 0($v0) #guardamos la dirección de la vtableBool en la CIR
	...
	lw $t0, 44($t0) # Calcular la dirección del método en la vtable

	jalr $t0 # Llamar al método out_bool
	...
	la $a0, str_const_37_32 # Guardamos el valor en la CIR en un temporal
	...
	or $t0 $t0 $t1 #Hacemos la operacion or entre exp izq y exp der
	...
	la $a0, str_const_39_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_41_29 # Guardamos el valor en la CIR en un temporal
	...
	lw $t0, 4($a0) #cargar el valor del bool

	li $t1, 1

	xor $t0, $t0, $t1 #invertir el valor del bool
	...
	la $t2, VTABLE_Bool # Cargar la dirección de la vtable de Bool en un temporal

	sw $t2, 0($v0) #guardamos la dirección de la vtableInt en la CIR

	sw $t0, 4($v0) #guardar el valor del int
	...
	la $a0, str_const_43_21 # Guardamos el valor en la CIR en un temporal
	...
	li $a0, 52  #  len() bytes + padding + su vtable
	...
	la $a0, str_const_45_62 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_46_38 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_50_40 # Guardamos el valor en la CIR en un temporal
	...
	lw $t1, 4($a0) #cargar el valor del int

	mul $t1, $t1, $t0 #multiplicar por -1
	...
	la $t2, VTABLE_Int # Cargar la dirección de la vtable de Int en un temporal

	sw $t2, 0($v0) #guardamos la dirección de la vtableInt en la CIR

	sw $t1, 4($v0) #guardar el valor del int
	...
	li $t0, 78 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_52_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_54_38 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_56_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_58_45 # Guardamos el valor en la CIR en un temporal
	...
	xori $t0, $t0, 1 #niego lo anterior para obtener mayor o igual
	...
	la $a0, str_const_60_21 # Guardamos el valor en la CIR en un temporal
	...
	li $a0, 36  #  len() bytes + padding + su vtable
	...
	la $a0, str_const_62_47 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_64_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_66_45 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_68_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_70_38 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_72_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_74_39 # Guardamos el valor en la CIR en un temporal
	...
	li $t0, 24 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_76_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_78_38 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_80_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_83_45 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_85_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_87_46 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_91_45 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_93_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_96_37 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_98_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_100_38 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_102_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_104_39 # Guardamos el valor en la CIR en un temporal
	...
	sw $t0, 0($v0) #guardamos la dirección de la vtableDouble en la CIR

	ldc1 $f0, double_const_105_23 # Guardamos el valor en la CIR en un temporal

	swc1 $f0, 4($v0) #guardar el valor del double

	swc1 $f1, 8($v0) #cargar la segunda mitad del valor del double
	...
	c.eq.d $f0, $f2 #comparamos si el double es igual al lado derecho

	li $t1 0 #si son iguales saltamos a la label true

	bc1t true_105_26#si son iguales saltamos a la label true

	li $t1 1 #si no son iguales cargamos este valor para restar

	true_105_26:

	li $t0, 1 #Si son iguales no se cargo el valor anterior

	sub $t0, $t0, $t1 #Si son iguales seteamos el valor a 1, sino a 0
	...
	la $a0, str_const_106_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_108_42 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_110_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_112_42 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_114_21 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_116_44 # Guardamos el valor en la CIR en un temporal
	...
	ldc1 $f0, double_const_117_23 # Guardamos el valor en la CIR en un temporal
	...
	ldc1 $f0, double_const_117_28 # Guardamos el valor en la CIR en un temporal
	...
	bc1t true_117_28#si son iguales saltamos a la label true
	...
	xor $t0, $t0, 1 #Invertimos el valor anterior para obtener el valor final
	...
	la $a0, str_const_118_21 # Guardamos el valor en la CIR en un temporal
