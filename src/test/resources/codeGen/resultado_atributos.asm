...
main:
	...
	sw $a0 16($v0) #Inicializamos el atributo d
	...
	m_start_54_5_end: # Label para el return del metodo
	...
	m_A_18_5_end: # Label para el return del metodo
	...
	m_set_a_22_12: # Label del metodo
	...
	m_set_a_22_12_end: # Label para el return del metodo
	...
	m_get_a_26_16: # Label del metodo
	...
	j m_get_a_26_16_end # Salta al epilogo del método

	li $a0, 0 # Valor de retorno por defecto

	m_get_a_26_16_end: # Label para el return del metodo
	...
	#Comienza codigo para llamada de metodo set_a
	...
	jalr $t0 # Llamar al método set_a
	...
	m_B_34_5_end: # Label para el return del metodo
	...
	m_print_40_12: # Label del metodo
	...
	#Comienza codigo para llamada de metodo get_a
	...
	jalr $t0 # Llamar al método get_a
	...
	la $a0, str_const_45_25 # Guardamos el valor en la CIR en un temporal
	...
	lw $a0 ,16($t0) #Buscamos el atributo en la CIR
	...
	m_print_40_12_end: # Label para el return del metodo
