...
main:
	...
	#Comienza codigo para llamada de metodo retornonil
	...
	jalr $t0 # Llamar al método retornonil
	...
	m_A_5_1_end: # Label para el return del metodo
	...
	m_retornonil_7_21: # Label del metodo
	...
	m_retornonil_7_21_end: # Label para el return del metodo
