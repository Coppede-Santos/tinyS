.data
str_const_54_45: .asciiz "esta funcionando ionicamente"
str_const_55_19: .asciiz "\n"
VTABLE_Fibonacci: #Vtable de la clase Fibonacci
.word m_Fibonacci_28_2
.word m_imprimo_sucesion_38_20
.word m_imprimo_numero_33_18
.word m_sucesion_fib_7_20
.word m_probar_43_17
str_const_41_18: .asciiz "\n"
str_const_34_18: .asciiz "f_"
str_const_36_17: .asciiz "="
...
main:
	...
	addiu $a0 $fp , -8 #Devolvemos la direccion de la variable en la pila io_2
	...
	la $a0, str_const_54_45 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_55_19 # Guardamos el valor en la CIR en un temporal
	...
	addiu $a0 $fp , -4 #Devolvemos la direccion de la variable en la pila ob_1

	sw $a0, 0($sp)

	addi $sp, $sp, -4

	#Comienza codigo para llamada de metodo Object
	...
	la $t0, VTABLE_Object # Cargar la dirección de la vtable en un temporal
	...
	jalr $t0 # Llamar al método Object
	...
	addiu $a0 $fp , -12 #Devolvemos la direccion de la variable en la pila fib_3
	...
	#Comienza codigo para llamada de metodo probar

	sw $fp 0($sp) # Guardar el frame pointer anterior en la pila

	addiu $sp $sp -4 # movemos el puntero de la pila

	addi $sp, $sp, -8 # guardamos en la pila el espacio para todos los argumentos
	...
	sw $a0 12($sp) # Guardar el argumento en la pila
	...
	jalr $t0 # Llamar al método probar

	addi $sp $sp 8 # movemos el puntero de la pila para sacar los parametros
	...
	addiu $a0 $fp , -16 #Devolvemos la direccion de la variable en la pila n_4
	...
	m_start_47_6_end: # Label para el return del metodo
	...
	m_Fibonacci_28_2: # Label del metodo
	...
	m_Fibonacci_28_2_end: # Label para el return del metodo
	...
	m_imprimo_sucesion_38_20: # Label del metodo
	...
	la $a0, str_const_41_18 # Guardamos el valor en la CIR en un temporal
	...
	m_imprimo_sucesion_38_20_end: # Label para el return del metodo
	...
	m_imprimo_numero_33_18: # Label del metodo
	...
	la $a0, str_const_34_18 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_36_17 # Guardamos el valor en la CIR en un temporal
	...
	m_imprimo_numero_33_18_end: # Label para el return del metodo
	...
	m_sucesion_fib_7_20: # Label del metodo
	...
	bne $a0, 1, falseIS_10_3 # Si no se cumple la condición salta a la labelFalse
	...
	j doneIS_10_3 #Salta al doneLabel, se termina el if

	falseIS_10_3: #labelFalse de if
	...
	bne $a0, 1, falseIS_14_6 # Si no se cumple la condición salta a la labelFalse
	...
	j doneIS_14_6 #Salta al doneLabel, se termina el if

	falseIS_14_6: #labelFalse de if
	...
	doneIS_14_6: #labelDone del if

	doneIS_10_3: #labelDone del if
	...
	j m_sucesion_fib_7_20_end # Salta al epilogo del método

	li $a0, 0 # Valor de retorno por defecto

	m_sucesion_fib_7_20_end: # Label para el return del metodo
	...
	m_probar_43_17: # Label del metodo
	...
	lw $a0 ,12($fp) #Buscamos el parametro en la pila

	j m_probar_43_17_end # Salta al epilogo del método

	li $a0, 0 # Valor de retorno por defecto

	m_probar_43_17_end: # Label para el return del metodo
