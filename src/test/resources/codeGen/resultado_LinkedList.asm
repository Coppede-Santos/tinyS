.data
VTABLE_Node: #Vtable de la clase Node
.word m_Node_7_5
.word m_getValue_9_19
.word m_setNextNode_21_23
.word m_getNextNode_13_23
.word m_setValue_17_20
VTABLE_LinkedList: #Vtable de la clase LinkedList
.word m_LinkedList_31_5
.word m_add_35_15
.word m_print_50_17
str_const_41_30: .asciiz "Added: "
str_const_43_25: .asciiz "\n"
str_const_45_29: .asciiz "Head: "
str_const_47_25: .asciiz "\n"
str_const_54_40: .asciiz "- - - - - - - -\n"
str_const_55_48: .asciiz "Printing Linked List...\n"
str_const_57_29: .asciiz "Head: "
str_const_59_25: .asciiz "\n"
str_const_61_37: .asciiz "Current Node: "
str_const_63_25: .asciiz "\n"
str_const_67_38: .asciiz "Linked List: \n"
str_const_70_28: .asciiz "["
str_const_72_28: .asciiz "]"
str_const_75_35: .asciiz " -> "
...
main:
	...
	addiu $a0 $fp , -4 #Devolvemos la direccion de la variable en la pila list_1

	sw $a0, 0($sp)

	addi $sp, $sp, -4

	#Comienza codigo para llamada de metodo LinkedList
	...
	sw $a0 4($v0) #Inicializamos el atributo nextNode
	...
	sw $a0 8($v0) #Inicializamos el atributo value
	...
	sw $a0 4($v0) #Inicializamos el atributo head
	...
	jalr $t0 # Llamar al método LinkedList
	...
	#Comienza codigo para llamada de metodo add
	...
	li $t0, 20 # Guardamos el valor en la CIR en un temporal
	...
	li $t0, 30 # Guardamos el valor en la CIR en un temporal
	...
	#Comienza codigo para llamada de metodo print
	...
	jalr $t0 # Llamar al método print
	...
	m_start_81_5_end: # Label para el return del metodo
	...
	m_Node_7_5_end: # Label para el return del metodo
	...
	m_getValue_9_19: # Label del metodo
	...
	j m_getValue_9_19_end # Salta al epilogo del método

	li $a0, 0 # Valor de retorno por defecto

	m_getValue_9_19_end: # Label para el return del metodo
	...
	m_setNextNode_21_23: # Label del metodo
	...
	lw $a0 0($a0) # Cargamos el CIR del encadenado previo

	addiu $a0 $a0 , 4 #Devolvemos la direccion del atributo en la CIR del encadenado previo
	...
	m_setNextNode_21_23_end: # Label para el return del metodo
	...
	m_getNextNode_13_23: # Label del metodo
	...
	j m_getNextNode_13_23_end # Salta al epilogo del método

	li $a0, 0 # Valor de retorno por defecto

	m_getNextNode_13_23_end: # Label para el return del metodo
	...
	m_setValue_17_20: # Label del metodo
	...
	addiu $a0 $a0 , 8 #Devolvemos la direccion del atributo en la CIR del encadenado previo
	...
	m_setValue_17_20_end: # Label para el return del metodo
	...
	m_LinkedList_31_5: # Label del metodo
	...
	m_LinkedList_31_5_end: # Label para el return del metodo
	...
	addiu $a0 $fp , -4 #Devolvemos la direccion de la variable en la pila newNode_1

	sw $a0, 0($sp)

	addi $sp, $sp, -4

	#Comienza codigo para llamada de metodo Node
	...
	#Comienza codigo para llamada de metodo setValue
	...
	lw $t0, 16($t0) # Calcular la dirección del método en la vtable

	jalr $t0 # Llamar al método setValue
	...
	#Comienza codigo para llamada de metodo setNextNode
	...
	jalr $t0 # Llamar al método setNextNode
	...
	la $a0, str_const_41_30 # Guardamos el valor en la CIR en un temporal
	...
	#Comienza codigo para llamada de metodo getValue
	...
	jalr $t0 # Llamar al método getValue
	...
	la $a0, str_const_43_25 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_45_29 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_47_25 # Guardamos el valor en la CIR en un temporal
	...
	m_add_35_15_end: # Label para el return del metodo
	...
	m_print_50_17: # Label del metodo
	...
	addiu $a0 $fp , -4 #Devolvemos la direccion de la variable en la pila currentNode_1
	...
	la $a0, str_const_54_40 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_55_48 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_57_29 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_59_25 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_61_37 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_63_25 # Guardamos el valor en la CIR en un temporal
	...
	beq $t0, $t1, true_65_40 #Si ambos son true, seteamos el valor a 1, sino a 0
	...
	la $a0, str_const_67_38 # Guardamos el valor en la CIR en un temporal
	...
	beq $t0, $t1, true_69_34 #Si ambos son true, seteamos el valor a 1, sino a 0
	...
	bne $a0, 1, doneWS_69_13 #En caso de que la condición no se cumpla, saltamos al done label.
	...
	la $a0, str_const_70_28 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_72_28 # Guardamos el valor en la CIR en un temporal
	...
	#Comienza codigo para llamada de metodo getNextNode
	...
	jalr $t0 # Llamar al método getNextNode
	...
	beq $t0, $t1, true_74_35 #Si ambos son true, seteamos el valor a 1, sino a 0
	...
	bne $a0, 1, falseIS_74_14 # Si no se cumple la condición salta a la labelFalse
	...
	la $a0, str_const_75_35 # Guardamos el valor en la CIR en un temporal
	...
	j doneIS_74_14 #Salta al doneLabel, se termina el if

	falseIS_74_14: #labelFalse de if

	doneIS_74_14: #labelDone del if

	j loopS_69_13 #Volvemos al loop

	doneWS_69_13: #termina el loop

	li $a0, 0 # Valor de retorno por defecto

	m_print_50_17_end: # Label para el return del metodo
