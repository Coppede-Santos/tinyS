.data
str_const_27_17: .asciiz "\n"
str_const_30_17: .asciiz "\n"
VTABLE_MathUtils: #Vtable de la clase MathUtils
.word m_MathUtils_9_1
.word m_suma_15_14
.word m_cuadrado_11_18
...
main:
	...
	la $a0, VTABLE_MathUtils # Cargar la dirección de la vtable de la clase MathUtils

	sw $a0, 0($v0) # Guardar la vtable en la CIR

	move $a0, $v0 # La dirección del objeto queda en $a0

	#Comienza codigo para llamada de metodo cuadrado
	...
	jalr $t0 # Llamar al método cuadrado
	...
	la $a0, str_const_27_17 # Guardamos el valor en la CIR en un temporal
	...
	#Comienza codigo para llamada de metodo suma
	...
	m_start_21_5_end: # Label para el return del metodo
	...
	m_MathUtils_9_1: # Label del metodo
	...
	m_MathUtils_9_1_end: # Label para el return del metodo
	...
	j m_suma_15_14_end # Salta al epilogo del método

	li $a0, 0 # Valor de retorno por defecto

	m_suma_15_14_end: # Label para el return del metodo
	...
	m_cuadrado_11_18: # Label del metodo
	...
	j m_cuadrado_11_18_end # Salta al epilogo del método

	li $a0, 0 # Valor de retorno por defecto

	m_cuadrado_11_18_end: # Label para el return del metodo
