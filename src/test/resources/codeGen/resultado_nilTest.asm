.data
str_const_24_28: .asciiz "Nodo es nil\n"
str_const_27_31: .asciiz "Nodo no es nil\n"
str_const_30_17: .asciiz "\n"
str_const_37_28: .asciiz "Nodo es nil\n"
str_const_40_31: .asciiz "Nodo no es nil\n"
str_const_43_17: .asciiz "\n"
VTABLE_Nodo: #Vtable de la clase Nodo
.word m_Nodo_13_1
.word m_get_valor_9_16
...
main:
	...
	beq $t0, $t1, true_23_13 #Si ambos son true, seteamos el valor a 1, sino a 0
	...
	bne $a0, 1, falseIS_23_2 # Si no se cumple la condición salta a la labelFalse
	...
	la $a0, str_const_24_28 # Guardamos el valor en la CIR en un temporal
	...
	j doneIS_23_2 #Salta al doneLabel, se termina el if

	falseIS_23_2: #labelFalse de if
	...
	la $a0, str_const_27_31 # Guardamos el valor en la CIR en un temporal
	...
	addiu $a0 $fp , -4 #Devolvemos la direccion de la variable en la pila x_1
	...
	#Comienza codigo para llamada de metodo get_valor
	...
	jalr $t0 # Llamar al método get_valor
	...
	beq $t0, $t1, true_36_13 #Si ambos son true, seteamos el valor a 1, sino a 0
	...
	la $a0, str_const_37_28 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_40_31 # Guardamos el valor en la CIR en un temporal
	...
	la $a0, str_const_43_17 # Guardamos el valor en la CIR en un temporal
	...
	m_start_19_5_end: # Label para el return del metodo
	...
	m_Nodo_13_1_end: # Label para el return del metodo
	...
	m_get_valor_9_16: # Label del metodo
	...
	j m_get_valor_9_16_end # Salta al epilogo del método

	li $a0, 0 # Valor de retorno por defecto

	m_get_valor_9_16_end: # Label para el return del metodo
