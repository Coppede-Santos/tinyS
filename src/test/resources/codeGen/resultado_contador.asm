...
VTABLE_Contador: #Vtable de la clase Contador
.word m_Contador_21_1
.word m_dec_16_10
.word m_inc_11_10
...
main:
	...
	#Comienza codigo para llamada de metodo Contador
	...
	la $t0, VTABLE_Contador # Cargar la dirección de la vtable en un temporal
	...
	sw $a0 4($v0) #Inicializamos el atributo valor
	...
	jalr $t0 # Llamar al método Contador
	...
	#Comienza codigo para llamada de metodo inc
	...
	#Comienza codigo para llamada de metodo dec
	...
	m_start_27_5_end: # Label para el return del metodo
	...
	m_Contador_21_1: # Label del metodo
	...
	m_Contador_21_1_end: # Label para el return del metodo
	...
	j m_dec_16_10_end # Salta al epilogo del método

	li $a0, 0 # Valor de retorno por defecto

	m_dec_16_10_end: # Label para el return del metodo
	...
	j m_inc_11_10_end # Salta al epilogo del método

	li $a0, 0 # Valor de retorno por defecto

	m_inc_11_10_end: # Label para el return del metodo
